...
class DwonloadPDFActivity : AppCompatActivity() {
    ...
    private fun getPdfs(immigrationId: String) {
                            ...
                            200 -> {
                              //  Utils.showToast(applicationContext, response.body()!!.message)
                                if(response.isSuccessful) {
                                    ...
                                    adapterPdf = AdapterPDF(this@DwonloadPDFActivity,listPDF)
     ...
     fun dwonloadPDF(url:String){
            ...
            if (file!!.exists()) {
                ...
                request.setTitle("Immigration Downloading " + "Sample"+ts + extenstion_filename)
